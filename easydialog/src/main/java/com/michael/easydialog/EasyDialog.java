...
public class EasyDialog
{
    ...
    private void initDialog(final Context context)
    {
       ...
       rlOutsideBackground.setOnTouchListener(new View.OnTouchListener()
        ...
        objectAnimatorsForDialogShow = new ArrayList<Animator>();
        objectAnimatorsForDialogDismiss = new ArrayList<Animator>();
        ini();
    }
     ...
     */
    public EasyDialog setLocationByAttachedView(final View attachedView)
    {
    ...
    public EasyDialog show()
    {
        if (dialog != null)
        {
            ...
            dialog.show();
            attachedView.getViewTreeObserver().addOnGlobalLayoutListener(attchViewLayoutListener);
